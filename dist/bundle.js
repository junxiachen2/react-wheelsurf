...
var Index = function (_Component) {
  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {
      this.ws = new _wheelsurf2.default(this.ws);
    }
  }, {
    key: 'start',
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          outStyle = _props2.outStyle,
          innerStyle = _props2.innerStyle,
          pointerStyle = _props2.pointerStyle;

      return _react2.default.createElement(
        'div',
        { className: 'cjx-container' },
        _react2.default.createElement(
          'div',
          { className: 'cjx-outTable', style: outStyle },
          _react2.default.createElement('div', { className: 'cjx-innerTable', style: innerStyle, ref: function ref(res) {
              _this3.ws = res;
            } }),
          _react2.default.createElement('div', { className: 'cjx-pointer', style: pointerStyle, onClick: this.start.bind(this) })
        )
      );
    }
  }]);
